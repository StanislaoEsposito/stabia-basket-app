...
/* ── Lista squadre ── */
const TEAMS = [
  { name: "DIV. REG. 1",             category: "NPS" },
  { name: "SERIE B FEMM.",           category: "BFS" },
  { name: "U19 FEMM.",               category: "BFS" },
  { name: "U19 GOLD",                category: "NPS" },
  { name: "U17 GOLD",                category: "NPS" },
  { name: "U19 LIBERTAS/U17 SILVER", category: "NPS" },
  { name: "U15 FEMM.",               category: "BFS" },
  { name: "U14 SILVER",              category: "BTS" },
  { name: "U13 SILVER",              category: "BTS" },
  { name: "ESORDIENTI",              category: "BTS" },
  { name: "AQUILOTTI 2016",          category: "MiniBasket" },
  { name: "AQUILOTTI 2017",          category: "MiniBasket" },
